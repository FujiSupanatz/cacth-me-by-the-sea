 ...
 const int sensor1Pin = 2; // Connect the sensor's signal pin to digital pin 2
 ...
 const int sensorPin3 = 12;
  ...
  while (true) {
    ...
    int objectCount = 0; // Counter to keep track of detected objects
    ...
    if (objectCount > 0) {
      // Object detected by at least one sensor
      bottleCount += objectCount; // Increment bottle count by the number of detected objects
